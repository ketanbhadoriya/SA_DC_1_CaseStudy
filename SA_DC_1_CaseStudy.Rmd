...
---
#Sentiment Analysis of Tweets across different States of United States (Data taken from Datacamp.com)
...
Comments : While the "bing" lexicon classifies words into 2 sentiments, 
...
Comments : #We can see the average frequency and the sentiment associated with each word, that exists in both data frames.
...
**Comments : Kentucky is the State which uses lots of postive words, while Louisiana with most negative words in their Tweets.**